...
try:
    ...
    _import_structure['beam_constraints'] = ['Constraint',
        'ConstraintListState', 'DisjunctiveConstraint', 'PhrasalConstraint']
    _import_structure['beam_search'] = ['BeamHypotheses', 'BeamScorer',
        'BeamSearchScorer', 'ConstrainedBeamSearchScorer']
    _import_structure['logits_process'] = ['EpsilonLogitsWarper',
        'EtaLogitsWarper', 'ForcedBOSTokenLogitsProcessor',
        'ForcedEOSTokenLogitsProcessor', 'HammingDiversityLogitsProcessor',
        'InfNanRemoveLogitsProcessor', 'LogitsProcessor',
        'LogitsProcessorList', 'LogitsWarper', 'MinLengthLogitsProcessor',
        ...
        'TypicalLogitsWarper', 'EncoderNoRepeatNGramLogitsProcessor',
        'ExponentialDecayLengthPenalty', 'LogitNormalization']
    _import_structure['stopping_criteria'] = ['MaxNewTokensCriteria',
        'MaxLengthCriteria', 'MaxTimeCriteria', 'StoppingCriteria',
        'StoppingCriteriaList', 'validate_stopping_criteria']
    _import_structure['utils'] = ['GenerationMixin',
        'top_k_top_p_filtering', 'GreedySearchEncoderDecoderOutput',
        'GreedySearchDecoderOnlyOutput', 'SampleEncoderDecoderOutput',
        'SampleDecoderOnlyOutput', 'BeamSearchEncoderDecoderOutput',
        'BeamSearchDecoderOnlyOutput', 'BeamSampleEncoderDecoderOutput',
...
try:
    ...
    _import_structure['tf_logits_process'] = ['TFForcedBOSTokenLogitsProcessor'
        , 'TFForcedEOSTokenLogitsProcessor', 'TFLogitsProcessor',
        'TFLogitsProcessorList', 'TFLogitsWarper',
        'TFMinLengthLogitsProcessor', 'TFNoBadWordsLogitsProcessor',
        'TFNoRepeatNGramLogitsProcessor',
        'TFRepetitionPenaltyLogitsProcessor', 'TFTemperatureLogitsWarper',
        'TFTopKLogitsWarper', 'TFTopPLogitsWarper',
        'TFForceTokensLogitsProcessor',
        'TFSuppressTokensAtBeginLogitsProcessor',
        'TFSuppressTokensLogitsProcessor']
    _import_structure['tf_utils'] = ['TFGenerationMixin',
        'tf_top_k_top_p_filtering', 'TFGreedySearchDecoderOnlyOutput',
        'TFGreedySearchEncoderDecoderOutput',
        'TFSampleEncoderDecoderOutput', 'TFSampleDecoderOnlyOutput',
...
try:
    ...
    _import_structure['flax_logits_process'] = [
        ...
        'FlaxForcedEOSTokenLogitsProcessor', 'FlaxLogitsProcessor',
        'FlaxLogitsProcessorList', 'FlaxLogitsWarper',
        'FlaxMinLengthLogitsProcessor', 'FlaxTemperatureLogitsWarper',
...
if TYPE_CHECKING:
    ...
    try:
        ...
        from .flax_logits_process import FlaxForcedBOSTokenLogitsProcessor, FlaxForcedEOSTokenLogitsProcessor, FlaxLogitsProcessor, FlaxLogitsProcessorList, FlaxLogitsWarper, FlaxMinLengthLogitsProcessor, FlaxTemperatureLogitsWarper, FlaxTopKLogitsWarper, FlaxTopPLogitsWarper
    ...
    sys.modules[__name__] = _LazyModule(__name__, globals()['__file__'],
        _import_structure, module_spec=__spec__)
